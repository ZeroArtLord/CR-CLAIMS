            ...
            <Reveal delay={80}>
              <div className="mb-10 lg:mb-12">
                ...
                <p className="text-base lg:text-lg text-muted-foreground leading-relaxed mb-4">
                  {content.reassurance.lead}
                </p>
                <p className="text-base lg:text-lg text-muted-foreground leading-relaxed">
                  {content.reassurance.body}
                </p>
              </div>
            </Reveal>

            <div className="space-y-4">
              {content.reassurance.items.map((item, index) => (
                <Reveal key={index} delay={index * 80}>
                  <div className="flex items-center gap-4 bg-white sm:bg-gradient-to-r sm:from-accent/5 sm:to-transparent rounded-[1.25rem] lg:rounded-[1.5rem] p-4 lg:p-5 border border-border/20 sm:border-accent/10 transition-all duration-300 hover:from-accent/10 hover:border-accent/20 hover:shadow-md group">
