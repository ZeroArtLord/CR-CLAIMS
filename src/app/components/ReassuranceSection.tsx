...
const promises = [
  ...
  "Maximum settlement guaranteed",
];

export function ReassuranceSection() {
  return (
    <section className="py-16 lg:py-24 px-6 lg:px-12 xl:px-16 bg-white">
      <div className="max-w-[1200px] mx-auto">
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 xl:gap-20 lg:items-center">
          ...
          <div className="relative w-full h-[280px] lg:h-[400px] xl:h-[480px] rounded-[2rem] lg:rounded-[2.5rem] overflow-hidden mb-10 lg:mb-0 shadow-xl shadow-black/5">
            <ImageWithFallback
              src="https://images.unsplash.com/photo-1765862835282-cd3d9190d246?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVnYW50JTIwaG9tZSUyMGludGVyaW9yJTIwcGVhY2VmdWx8ZW58MXx8fHwxNzc1Njc4OTIzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          ...
          <div>
            ...
            <div className="mb-10 lg:mb-12">
              ...
              <p className="text-base lg:text-lg text-muted-foreground leading-relaxed">
                We take the stress out of insurance claims so you can focus on recovery
              </p>
            </div>
            ...
            <div className="space-y-4">
              {promises.map((promise, index) => (
                ...
                >
                  ...
                  <p className="text-base lg:text-lg text-foreground tracking-tight">{promise}</p>
                </div>
              ))}
            </div>
          </div>
