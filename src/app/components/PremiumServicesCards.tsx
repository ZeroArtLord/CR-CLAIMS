              ...
              <Reveal key={index} delay={index * 90}>
                ...
                >
                  ...
                  <div className="relative">
                    {/* Icon */}
                    <div className={`w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 ${styles.iconBg} rounded-[1.5rem] sm:rounded-[1.75rem] lg:rounded-[2rem] flex items-center justify-center mb-6 sm:mb-7 lg:mb-8 shadow-md shadow-black/5`}>
                      <Icon className={`w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 ${styles.iconColor}`} strokeWidth={1.5} />
                    </div>
