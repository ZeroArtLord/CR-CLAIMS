          ...
          <div className="lg:order-1 mb-10 lg:mb-0">
              ...
              <div className="hidden lg:block mb-6 lg:mb-8">
                <img
                  ...
                  style={{
                    ...
                    WebkitFilter:
                      "drop-shadow(0 2px 4px rgba(0,0,0,0.2)) drop-shadow(0 1px 2px rgba(0,0,0,0.4))",
                  }}
                />
              </div>
            </Reveal>
            ...
            <Reveal delay={80}>
              <div className="space-y-4 sm:space-y-5 lg:space-y-6 mb-10 lg:mb-8 text-center lg:text-left">
                ...
                <p className="text-xs lg:text-sm text-muted-foreground/70">{content.hero.license}</p>
              </div>
            </Reveal>
